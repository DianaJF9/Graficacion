...
export class CanvasLocal {
  ...
  paint() {
    let maxEsc: number = 100;
    let h: number[] = [10, 30, 80, 50]
    let colors: string[] = ['skyblue', 'limegreen', 'deeppink', 'darkorange'];
    ...
    for (let i = 0.5; i <= 8; i += 2) {
      let sombra: string;
      if (colors[ind] === 'skyblue') sombra = 'rgb(70, 130, 180)';       // versión más oscura
      else if (colors[ind] === 'limegreen') sombra = 'rgb(0, 100, 0)';
      else if (colors[ind] === 'deeppink') sombra = 'rgb(199, 21, 133)';
      else if (colors[ind] === 'darkorange') sombra = 'rgb(205, 102, 0)';
      else sombra = colors[ind];
      ...
      this.graphics.fillRect(
        ...
        this.iX(2) - this.iX(1), (this.iY(0) - this.iY(5 * h[ind] / maxEsc)) );
      ...
      this.drawRmboide(
        this.iX(i + 0.5), this.iY(5), // Empieza en la parte superior coloreada
        this.iX(i + 1.5), this.iY(5),
        this.iX(i + 1), this.iY(5-0.5), // Termina en la parte superior de la gráfica
      ...
      this.drawRmboide(
        this.iX(i + 1),this.iY((5 * h[ind] / maxEsc) - 0.5),
        this.iX(i + 1.5), this.iY((5 * h[ind] / maxEsc)),
        this.iX(i + 1.5), this.iY(0),
        this.iX(i + 1), this.iY(-0.5),
        sombra); 
      ...
      this.drawRmboide(
        this.iX(i + 1), this.iY((5 * h[ind] / maxEsc) - 0.5),
        this.iX(i + 1.5), this.iY((5 * h[ind] / maxEsc)),
        this.iX(i + 1.5), this.iY(5), // Termina en la parte superior de la gráfica
      ...
      this.graphics.fillRect(
        this.iX(i), this.iY(4.5), // Comenzar en la parte superior de la barra
